...
graph LR
    ...
    subgraph Phase2["2. Core Domain Architecture"]
        #2:::foundation --> #5:::core --> #3:::core --> #4:::core --> #6:::core
    end

    subgraph Phase3["3. Main Business Workflows"]
        #6:::core --> #7:::feature --> #8:::feature --> #9:::feature --> #10:::feature --> #11:::feature
    end

    subgraph Phase4["4. Integration & Reliability"]
        #11:::feature --> #20:::feature --> #12:::feature --> #13:::feature --> #14:::feature
    end

    subgraph Phase5["5. Polish & Delivery"]
        #14:::feature --> #15:::final --> #16:::final --> #17:::final --> #18:::final --> #19:::final
    end
```
